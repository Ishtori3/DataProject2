...
df=pd.read_csv("https://odre.opendatasoft.com/explore/dataset/eco2mix-regional-cons-def/download/?format=csv&timezone=Europe/Berlin&lang=en&use_labels_for_header=true&csv_separator=%3B", sep=";")
